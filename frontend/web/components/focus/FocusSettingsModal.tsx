...
export function FocusSettingsModal({
  ...
  return (
    <div
      ...
      role="dialog"
    >
      <div className="max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-y-auto rounded-2xl border border-dashboard-border bg-dashboard-raised p-5 shadow-panel sm:p-6">
        <div className="mb-5 flex items-center justify-between">
          ...
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-lg text-xl text-dashboard-muted hover:bg-dashboard-surface hover:text-dashboard-text"
            onClick={onClose}
            type="button"
          >
            &times;
