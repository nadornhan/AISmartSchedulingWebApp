  ...
  return (
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="flex items-center overflow-hidden rounded-lg border border-dashboard-border">
        <button className="h-9 w-9 text-dashboard-muted hover:bg-dashboard-surface hover:text-dashboard-text" onClick={() => onChange(Math.max(min, value - 1))} type="button">−</button>
        ...
        <button className="h-9 w-9 text-dashboard-muted hover:bg-dashboard-surface hover:text-dashboard-text" onClick={() => onChange(Math.min(max, value + 1))} type="button">+</button>
      </div>
    </div>
  );
}
